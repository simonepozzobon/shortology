...
'<link rel="stylesheet" href="/wp-content/themes/shortology_new-child/magnific-popup.css" type="text/css" media="screen" />
 ...
 <meta property="og:image" content="/wp-content/themes/shortology_new-child/images/cortology_ogimage.png" />';
get_header();
		...
		<div class="<?php if($fullwidth == 2) echo 'twelve'; else echo 'sixteen';?> columns">
        	...
        	?>
        			<div style="text-align: center;">
						...
						<h4 style="font-family:Helvetica, Arial, sans-serif!important; font-style:normal!important; font-size:18px!important;">Ti senti ancora ispirato? <a style="font-family:Helvetica, Arial, sans-serif!important; font-style:normal!important; font-size:18px!important;" href="">Scrivi un'altra storia!</a></h4>
        			</div>
	        <?php
	        	}
...
6. In ogni momento potrai esercitare i diritti di cui allâ€™art. 7 del D. Lgs. 196/2003 (tra cui chi richiedere lâ€™aggiornamento, la modifica, l'integrazione dei tuoi dati personali, opporsi per motivi legittimi al trattamento, conoscere lâ€™elenco dei responsabili del trattamento) scrivendo allâ€™indirizzo di posta elettronica <a href="mailto:info@H-57.com">info@H-57.com</a>. </p-->
	        ...
	        ?>
				<div class="cortSlot">
					<p class="noFont" style="font-family:Helvetica, Arial, sans-serif!important;">Vuoi giocare a fare lo sceneggiatore? Tira la leva, scegli una sequenza<br />e inventati una storia, magari un giorno la realizzeremo per te!</p>
					...
					<div id="slotResult" style="display: none;">
						...
						<p class="noFont" style="font-family:Helvetica, Arial, sans-serif!important;">
							...
							<br /><span style="margin-right: 3px;">[</span><span id="codice"></span><span style="margin-left: 3px;">]</span>
						</p>
