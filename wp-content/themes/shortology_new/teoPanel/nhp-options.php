...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'upload',
						'title' => 'Logo image',
						'sub_desc' => 'If you upload a logo, the top header texts will no longer show up, the logo will replace them.'
						),
					array(
						'id' => 'bg_image',
						'type' => 'upload',
					...
					array(
						...
						'sub_desc' => 'If you want to override the default contact form an modify it, maybe add a captcha, install the Contact Form 7 plugin and get its shortcode and place it here. ',
						'std' => ''
						),
					array(
						'id' => 'email',
