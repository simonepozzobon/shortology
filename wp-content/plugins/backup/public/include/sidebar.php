...
<div id="sg-sidebar-wrapper" class="metro">
	<nav class="sidebar dark">
		<ul>
			...
			<li class="<?php echo strpos($page,'services')?'active':''?>"><a href="<?php echo network_admin_url('admin.php?page=backup_guard_services'); ?>"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>Services <span class="badge badge-info">New</span></a></li>
