                        ...
                        <fieldset>
							...
							<?php if(SGBoot::isFeatureAvailable('ALERT_BEFORE_UPDATE')): ?>
								<div class="form-group">
									...
									<div class="col-md-3 pull-right text-right">
										<label class="sg-switch-container">
											<input type="checkbox" name="alert-before-update" class="sg-switch" <?php echo $isAlertBeforeUpdateEnabled?'checked="checked"':''?>>
										</label>
									</div>
								</div>
							<?php endif; ?>
                            ...
                            <?php if(SGBoot::isFeatureAvailable('STORAGE')): ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pull-right text-right">
                                        <label class="sg-switch-container">
                                            <input type="checkbox" name="delete-backup-from-cloud" class="sg-switch" <?php echo $isDeleteBackupFromCloudEnabled?'checked="checked"':''?>>
                                        </label>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if(SGBoot::isFeatureAvailable('NUMBER_OF_ROWS_TO_BACKUP')): ?>
                                <div class="form-group">
